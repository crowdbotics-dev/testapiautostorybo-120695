...
## Project Structure
    ...
    ├── testapiautostorybo_120695  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_120695`
...
2. Clone this repo and `cd testapiautostorybo_120695`
